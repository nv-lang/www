---
title: "Hello, Nova"
description: "Представляю Nova: что это, почему я его создаю и что уже работает сегодня — алгебраические эффекты, статические контракты, M:N рантайм и инструменты документирования."
...
excerpt: "Представляю Nova — что это, почему я его создаю и что уже работает сегодня: алгебраические эффекты, статические контракты, M:N рантайм и инструменты документирования. Взгляд на стадию bootstrap и планы на будущее."
---

Сегодня я открываю двери **Nova** — языку программирования общего назначения системного уровня, который публично разрабатываю. В этом посте объясняется, что такое Nova, зачем он нужен и что уже работает прямо сейчас.
...
Я также принимаю контрибуции. В [руководстве для контрибьюторов](https://github.com/nv-lang/nova/blob/main/CONTRIBUTING.md) объясняется, где сейчас нужна помощь больше всего.

Язык молод. Идеи — нет. Я с нетерпением жду возможности строить его вместе с вами.
